      ...
      if (isFirebaseConfigured) {
        ...
        if (isLogin) {
          const registeredUsersRaw =
            localStorage.getItem("dama_simulated_users") || "[]";
      ...
      <div className="w-full max-w-md bg-white rounded-3xl p-6 md:p-8 shadow-apple-card border border-apple-gray-100/40 space-y-8 animate-float-up">
        ...
        <div className="text-center space-y-3">
          <img
            src="/logo.svg"
            alt="담아 로고"
            className="w-14 h-14 object-contain mx-auto transition-transform hover:scale-105"
          />
          <div>
            <h1 className="text-2xl font-extrabold tracking-tight text-apple-gray-800">
              추억을 온전히 담아내다
            </h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-4">
            <div className="space-y-1.5">
              <label className="block text-xs font-bold text-apple-gray-300 uppercase tracking-wide">
                이메일 주소
              </label>
        ...
        {!isFirebaseConfigured && <div className="pt-2"></div>}
      </div>
    </div>
  );
};
